  ...
  {    
    if(e1 instanceof Int && e2 instanceof Int)
    {
      ...
      if(this.operator.equals(BinaryOperator.PLUS))
        return new Value<Int>(int1.add(int2));
      if(this.operator.equals(BinaryOperator.MINUS))
        return new Value<Int>(int1.subtract(int2));
      if(this.operator.equals(BinaryOperator.MULTIPLY))
        return new Value<Int>(int1.multiply(int2));
      if(this.operator.equals(BinaryOperator.EQUALS))
        return new Value<Boolean>(new Boolean(int1.equals(int2)));
      if(this.operator.equals(BinaryOperator.LESS))
        return new Value<Boolean>(new Boolean(int1.lessThan(int2)));
      if(this.operator.equals(BinaryOperator.GREATER))
        return new Value<Boolean>(new Boolean(int1.greaterThan(int2)));
    ...
    else if(e1 instanceof Real && e2 instanceof Real)
    {
      ...
      Real real2 = (Real)e1;
      if(this.operator.equals(BinaryOperator.PLUS))
        return new Value<Real>(real1.add(real2));
      if(this.operator.equals(BinaryOperator.MINUS))
        return new Value<Real>(real1.add(real2));
      if(this.operator.equals(BinaryOperator.MULTIPLY))
        return new Value<Real>(real1.multiply(real2));
      if(this.operator.equals(BinaryOperator.EQUALS))
        return new Value<Boolean>(new Boolean(real1.equals(real2)));
      if(this.operator.equals(BinaryOperator.LESS))
        return new Value<Boolean>(new Boolean(real1.lessThan(real2)));
      if(this.operator.equals(BinaryOperator.GREATER))
        return new Value<Boolean>(new Boolean(real1.greaterThan(real2)));
      if(this.operator.equals(BinaryOperator.MOD))
        return new Value<Real>(real1.mod(real2));
    }
